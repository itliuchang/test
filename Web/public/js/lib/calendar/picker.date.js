                    ...
                    return [
                        Picker._.group({
                            ...
                            item: function( targetDate ) {
                                ...
                                if(settings.date[targetDate.month+1]&&settings.date[targetDate.month+1][targetDate.date]&&settings.date[targetDate.month+1][targetDate.date].text.className=='success'){
                                return [
                                    Picker._.node(
                                        'div',
                                        targetDate.date+
                                        Picker._.node(
                                            'p',
                                            settings.date[targetDate.month+1][targetDate.date].text.content,
                                            settings.date[targetDate.month+1][targetDate.date].text.className
                                            ),
                                        (function( klasses ) {
                                ...
                                var _content = '&nbsp', _className = 'last',
                                    _current = settings.date[targetDate.month+1];
                                if(_current&&_current[targetDate.date]&&_current[targetDate.date].text.className=='fail'){
                                    _content = _current[targetDate.date].text.content;
                                    _className = _current[targetDate.date].text.className;
                                }
                                return [
                                    Picker._.node(
                                        'div',
