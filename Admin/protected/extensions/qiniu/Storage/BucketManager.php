<?php
namespace ext\qiniu\Storage;

use ext\qiniu\Auth;
use ext\qiniu\Config;
use ext\qiniu\Functions;
use ext\qiniu\Http\Client;
use ext\qiniu\Http\Error;
...
final class BucketManager
{
     ...
     * @param $key        待删除资源的文件名
     *
     * @return mixed      成功返回NULL，失败返回对象ext\qiniu\Http\Error
